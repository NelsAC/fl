...
const formValidations = {
    title: [ (value) => value.length >= 3, 'El titulo debe tener almenos 3 caracteres.' ],
    description: [ (value) => value.length >= 10, 'La descripción debe tener almenos 10 caracteres.' ],
}
    ...
    <div className="modal__content--body">
      <form action="#" onSubmit={ onSubmit }>
        <div className="form__group">
          ...
          <select name="course" id="course" className="form__group--select" value={ course } onChange={ onInputChange }>
        ...
        <div className="form__submit">
          <button className="btn form__submit--btn" type="submit">Publicar</button>
        </div>
      </form>
    </div>
  );
